...
const partners = [
  ...
  { name: "SheFi", logo: shefiLogo, scale: 4.5, translateX: -30, translateY: -28 },
  { name: "Bitcoin India Conference", logo: bitcoinIndiaConferenceLogo, scale: 5, translateX: -10, translateY: 0 },
];
