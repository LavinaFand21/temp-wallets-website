...
const partners: Partner[] = [
  ...
  { name: "SheFi", logo: shefiLogo, scale: 1, translateX: 0, translateY: 0, bgSize: "280%", bgPosition: "22% 32%" },
  { name: "Bitcoin India Conference", logo: bitcoinIndiaConferenceLogo, scale: 1, translateX: 0, translateY: 0, bgSize: "220%", bgPosition: "44% 50%" },
];
