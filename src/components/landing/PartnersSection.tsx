...
const partners = [
  ...
  { name: "SheFi", logo: shefiLogo, scale: 1, translateX: 0, translateY: 0 },
  { name: "Bitcoin India Conference", logo: bitcoinIndiaConferenceLogo, scale: 1, translateX: 0, translateY: 0 },
];
